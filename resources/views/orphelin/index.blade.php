    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <section class="bg-blue-600 text-white rounded-xl p-8 mb-12">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="don.html" class="bg-white text-blue-600 px-6 py-3 rounded-lg font-medium hover:bg-blue-50 transition">Faire un don</a>
                    <a href="activites.html" class="border-2 border-white text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition">Nos activités</a>
                </div>
            </div>
        </section>
        ...
        <section class="mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                    <img src="http://static.photos/education/640x360/1" alt="Soutien scolaire" class="w-full h-48 object-cover">
                    <div class="p-6">
                        ...
                        <a href="activites.html#education" class="text-blue-600 font-medium">En savoir plus →</a>
                    </div>
                </div>
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                    <img src="http://static.photos/medical/640x360/2" alt="Campagne médicale" class="w-full h-48 object-cover">
                    <div class="p-6">
                        ...
                        <a href="activites.html#sante" class="text-blue-600 font-medium">En savoir plus →</a>
                    </div>
                </div>
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                    <img src="http://static.photos/agriculture/640x360/3" alt="Agriculture durable" class="w-full h-48 object-cover">
                    <div class="p-6">
                        ...
                        <a href="activites.html#agriculture" class="text-blue-600 font-medium">En savoir plus →</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                    <img src="http://static.photos/people/640x360/4" alt="Nouvelle école" class="w-full h-48 object-cover">
                    <div class="p-6">
                        ...
                        <a href="actualites.html#ecole" class="text-blue-600 font-medium">Lire l'article →</a>
                    </div>
                </div>
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                    <img src="http://static.photos/medical/640x360/5" alt="Mission médicale" class="w-full h-48 object-cover">
                    <div class="p-6">
                        ...
                        <a href="actualites.html#mission" class="text-blue-600 font-medium">Lire l'article →</a>
                    </div>
                </div>
            </div>
            <div class="text-center mt-8">
                <a href="actualites.html" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition">Voir toutes les actualités</a>
            </div>
        </section>
        ...
        <section class="bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-xl p-8 text-center">
            ...
            <a href="don.html" class="inline-block bg-white text-blue-600 px-8 py-3 rounded-lg font-medium hover:bg-blue-50 transition">Faire un don maintenant</a>
        </section>
    </main>
